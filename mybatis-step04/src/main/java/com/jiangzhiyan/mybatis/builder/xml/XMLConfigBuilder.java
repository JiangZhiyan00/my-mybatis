...
import com.jiangzhiyan.mybatis.datasource.DataSourceFactory;
import com.jiangzhiyan.mybatis.io.Resources;
import com.jiangzhiyan.mybatis.mapping.BoundSql;
...
public class XMLConfigBuilder extends BaseBuilder {
    ...
    public Configuration parse() {
        try {
            // 解析环境
            this.environmentsElement(root.element("environments"));
            // 解析映射器
